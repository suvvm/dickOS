...
_timerSetTime:
	...
	JAE	L359
L363:
	MOV	EDX,DWORD [_timerctl+12+ESI*4]
	MOV	EAX,DWORD [EDI]
	CMP	DWORD [EDX],EAX
	JAE	L359
	INC	ESI
...
L359:
	...
	JLE	L371
L368:
	MOV	EDX,_timerctl+12
	MOV	EAX,DWORD [-4+EDX+ECX*4]
	MOV	DWORD [EDX+ECX*4],EAX
	DEC	ECX
	CMP	ECX,ESI
	JG	L368
L371:
	MOV	DWORD [_timerctl+12+ESI*4],EDI
	LEA	EAX,DWORD [1+EBX]
...
_interruptHandler20:
	...
	JA	L372
	XOR	EBX,EBX
	CMP	EBX,DWORD [_timerctl+8]
	JAE	L375
L379:
	MOV	EDX,DWORD [_timerctl+12+EBX*4]
	MOV	EAX,DWORD [_timerctl]
	CMP	DWORD [EDX],EAX
	JA	L375
	MOVZX	EAX,BYTE [12+EDX]
	MOV	DWORD [4+EDX],1
	PUSH	EAX
	INC	EBX
	PUSH	DWORD [8+EDX]
...
L425:
	...
	MOV	EBX,DWORD [-228+EBP]
	ADD	ESP,20
	ADD	DWORD [-620+EBP],EBX
