...
L275:
	...
	XOR	EDI,EDI
	MOV	EAX,DWORD [4+EDX]
	ADD	ESI,DWORD [16+EDX]
	CMP	EDI,EAX
	JGE	L282
L274:
	MOV	ECX,DWORD [12+EDX]
	ADD	ECX,EDI
	CMP	DWORD [12+EBP],ECX
	JG	L270
	CMP	ECX,DWORD [20+EBP]
	JGE	L270
	CMP	DWORD [16+EBP],ESI
	JG	L270
	CMP	ESI,DWORD [24+EBP]
	JGE	L270
	IMUL	EAX,DWORD [-20+EBP]
	LEA	EBX,DWORD [EDI+EAX*1]
	MOV	EAX,DWORD [-24+EBP]
