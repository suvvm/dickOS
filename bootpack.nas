...
L338:
	...
	RET
L341:
	MOVZX	EAX,BYTE [_timerctl+12]
	PUSH	EAX
	PUSH	DWORD [_timerctl+8]
	CALL	_QueuePush
	POP	ECX
	POP	EAX
	JMP	L338
...
_setTimer:
	...
	CALL	_io_cli
	MOV	AL,BYTE [-16+EBP]
	MOV	DWORD [_timerctl+4],ESI
	MOV	DWORD [_timerctl+8],EDI
	MOV	BYTE [_timerctl+12],AL
	MOV	DWORD [8+EBP],EBX
	POP	ECX
	POP	EBX
	POP	ESI
...
L378:
	...
	ADD	ESP,20
	ADD	DWORD [-540+EBP],EBX
	ADD	DWORD [-536+EBP],EAX
	JS	L388
L379:
	CMP	DWORD [-540+EBP],0
	JS	L389
