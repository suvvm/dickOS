...
[SECTION .data]
LC1:
	DB	"memory %dMB free : %dKB",0x0A,0x0A,0x00
[SECTION .text]
	GLOBAL	_cmdMem
_cmdMem:
	PUSH	EBP
...
L569:
	...
	XOR	ECX,ECX
L574:
	MOV	AL,BYTE [1058312+EBX+ECX*1]
	MOV	BYTE [-35+EBP+ECX*1],AL
	INC	ECX
	CMP	ECX,2
	JLE	L574
	LEA	EAX,DWORD [-44+EBP]
...
LC7:
	DB	"type ",0x00
LC8:
	DB	"command not found",0x0A,0x0A,0x00
[SECTION .text]
	GLOBAL	_consoleRunCmd
_consoleRunCmd:
	PUSH	EBP
	MOV	EBP,ESP
	PUSH	EDI
